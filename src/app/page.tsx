      ...
      <section className="relative flex items-center justify-center text-center min-h-[80vh] overflow-hidden">
        ...
        <div className="container px-6 text-foreground">
          ...
          <p className="mt-4 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Kenya-wide professional data recovery for individuals, SMEs, and NGOs.
            We handle HDDs, SSDs, RAID/NAS, phones, and digital forensics — with confidentiality and care.
          </p>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    // pleasant fallback if image is missing:
